...
we set camera position (1,1,1) and orient it towards the origin. in orthographic : ![alt text](https://github.com/HaifaGraphicsCourses/computer-graphics-2023-mohamad-arrabi-mohamad-khaleel/blob/master/Assignment1Report/ortho%20a%20position.png) in prespective : ![alt text]()
